...
# filling the dictionary payload with searchtype and key,
# if it was input
if keywords1:
...
print('If you want to search for keywords in the title, '\
      'abstract and document, enter the keywords here. '\
      'IEEE xplore allows a maximum of 10 keywords.')
keywords3 = input()
if keywords3:
...
# try to assemble the request url a little more automatically
# by passing parameters with params
